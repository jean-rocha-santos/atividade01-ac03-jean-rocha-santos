...
public class CalcularFaturamentoProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of("Pizzaria 1", "(11) 99999-9999", List.of(p1, p2, p3, p4, p5), 802.0),
        Arguments.of("Pizzaria 2", "(11) 99999-9999", List.of(p1, p2, p3, p6), 602.0),
        Arguments.of("Pizzaria 3", "(11) 99999-9999", List.of(p1, p2, p3, p6, p7, p8), 1002.0),
        Arguments.of("Pizzaria 4", "(11) 99999-9999", List.of(p6, p7, p8, p9, p10), 1080.0),
        Arguments.of("Pizzaria 5", "(11) 99999-9999", List.of(), 0.0)
    );
  }
}
